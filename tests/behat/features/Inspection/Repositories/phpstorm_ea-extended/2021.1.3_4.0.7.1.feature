Feature: Run inspections
  ...
  Scenario: Run inspections on a project with problems
    ...
    And the last lines of the output should be:
    """
    50 problems were found during PhpStorm inspection.
    ...
    Problems in file:///{{ projectRoot }}/src/InspectionViolator.php:
      ...
      line 79   WEAK WARNING  (General exception is thrown) [EA] \Exception is too general. Consider throwing one of SPL exceptions instead.
